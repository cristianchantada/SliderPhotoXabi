...
public class ClienteDao implements DaoInterface<Cliente> {
	...
	private List<org.cvarela.sliderWeb.models.Cliente> listaClientes = new ArrayList<>();
	...
	@Override
	public org.cvarela.sliderWeb.models.Cliente get(org.cvarela.sliderWeb.models.Cliente cliente) {
		String clientNif = cliente.getNif();
		org.cvarela.sliderWeb.models.Cliente newCliente = new org.cvarela.sliderWeb.models.Cliente(clientNif);
